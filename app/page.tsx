...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-50/50 to-white text-gray-900">
      {/* Hero Section */}
      <section className="min-h-[50vh] flex flex-col justify-center px-6 py-12 max-w-4xl mx-auto">
        <p className="text-indigo-600 font-medium mb-2">Hi, I&apos;m</p>
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-2 border border-indigo-300 text-indigo-600 px-6 py-3 rounded-lg hover:bg-indigo-50 transition-colors"
          >
            Get in Touch
          </a>
        </div>
      ...
      {/* Projects Section */}
      <section id="projects" className="px-6 py-12 bg-indigo-50/30">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {/* Proofpoint */}
            <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 hover:border-indigo-200 hover:shadow-sm transition-all">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="text-xs bg-indigo-100 text-indigo-700 px-2.5 py-1 rounded-full">Atlassian</span>
                <span className="text-xs bg-indigo-100 text-indigo-700 px-2.5 py-1 rounded-full">Enterprise AI</span>
                <span className="text-xs bg-indigo-100 text-indigo-700 px-2.5 py-1 rounded-full">ChatGPT</span>
                <span className="text-xs bg-indigo-100 text-indigo-700 px-2.5 py-1 rounded-full">CoPilot</span>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 hover:border-indigo-200 hover:shadow-sm transition-all">
              <div className="flex items-start justify-between gap-4 mb-3">
                <div className="flex items-start gap-4">
                  <div className="w-11 h-11 bg-violet-100 rounded-lg flex items-center justify-center flex-shrink-0">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="text-xs bg-indigo-100 text-indigo-700 px-2.5 py-1 rounded-full">Claude AI</span>
                <span className="text-xs bg-indigo-100 text-indigo-700 px-2.5 py-1 rounded-full">Machine Learning</span>
                <span className="text-xs bg-indigo-100 text-indigo-700 px-2.5 py-1 rounded-full">Python</span>
                <span className="text-xs bg-indigo-100 text-indigo-700 px-2.5 py-1 rounded-full">REST API</span>
                <span className="text-xs bg-indigo-100 text-indigo-700 px-2.5 py-1 rounded-full">SaaS</span>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-6 hover:border-indigo-200 hover:shadow-sm transition-all">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="text-xs bg-indigo-100 text-indigo-700 px-2.5 py-1 rounded-full">Claude AI</span>
                <span className="text-xs bg-indigo-100 text-indigo-700 px-2.5 py-1 rounded-full">Next.js</span>
                <span className="text-xs bg-indigo-100 text-indigo-700 px-2.5 py-1 rounded-full">iOS</span>
                <span className="text-xs bg-indigo-100 text-indigo-700 px-2.5 py-1 rounded-full">eBay API</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Contact Section */}
      <section id="contact" className="px-6 py-12 bg-indigo-50/30">
      ...
      {/* Footer */}
      <footer className="px-6 py-6 border-t border-indigo-100 bg-white">
